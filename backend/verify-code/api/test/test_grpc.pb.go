...
const (
	Test_CreateTest_FullMethodName = "/api.test.Test/CreateTest"
	Test_UpdateTest_FullMethodName = "/api.test.Test/UpdateTest"
	Test_DeleteTest_FullMethodName = "/api.test.Test/DeleteTest"
	Test_GetTest_FullMethodName    = "/api.test.Test/GetTest"
	Test_ListTest_FullMethodName   = "/api.test.Test/ListTest"
)
